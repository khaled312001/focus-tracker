...
export function renderFocusStatistics(containerElement, focusData) {
    ...
    // Calculate total data points and average focus
    const totalDataPoints = Object.values(focusData.aggregated_data).reduce(
        (sum, student) => sum + parseInt(student.data_points), 0
    );
    ...
    overallStats.innerHTML = `
        ...
        <div class="space-y-2">
            <div class="flex justify-between">
                ...
                <span class="font-medium text-gray-800 dark:text-white">${totalDataPoints}</span>
            </div>
            <div class="flex justify-between">
                <span class="text-gray-600 dark:text-gray-400">Average Focus:</span>
                <span class="font-medium text-gray-800 dark:text-white">${averageFocus}%</span>
            </div>
            <div class="flex justify-between">
